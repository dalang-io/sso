...
fn build_templates() -> Environment<'static> {
    ...
    env.add_template(
        "members.html",
        include_str!("../templates/dashboard/members.html"),
    )
    .unwrap();
    env.add_template(
        "users.html",
        include_str!("../templates/dashboard/users.html"),
    )
    .unwrap();
    env.add_template(
        "user_detail.html",
        include_str!("../templates/dashboard/user_detail.html"),
    )
    .unwrap();
    env.add_template(
        "roles.html",
        include_str!("../templates/dashboard/roles.html"),
    )
    .unwrap();
    env.add_template(
        "groups.html",
        include_str!("../templates/dashboard/groups.html"),
    )
    .unwrap();
    env.add_template(
        "sessions.html",
    ...
    env.add_template(
        "settings.html",
        include_str!("../templates/dashboard/settings.html"),
    )
    .unwrap();
    env.add_template(
        "clients.html",
